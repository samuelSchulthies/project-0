       ...
       std::string currLine = inputLines.at(currLineIdx);
        ...
        if (lineNum == 0) {
            ...
            if (check(info, Info::TITLE)) {
                ...
                book->setHours(info.getInfo()); //This was going to the setPages function, thus overriding the pages variable with the hours.
                                                //Because pages is an int, the decimal was also dropped when overwritten.
            }
